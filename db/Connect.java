...
// run the file with mysql-connector with the below command assuming that mysql connector is in the same folder as the code
// java -classpath mysql-connector-j-8.0.31.jar Connect.java
...
public class Connect{
    ...
    private static final String DB_URL = "jdbc:mysql://YOUREMAIL@dijkstra.ug.bcc.bilkent.edu.tr/YOURDBNAME?user="
